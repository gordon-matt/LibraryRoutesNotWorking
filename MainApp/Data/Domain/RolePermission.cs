...
namespace FrameworkDemo.Data.Domain
{
    ...
    public class RolePermissionMap : IEntityTypeConfiguration<RolePermission>, IFrameworkEntityTypeConfiguration
    {
        public void Configure(EntityTypeBuilder<RolePermission> builder)
        {
            ...
            builder.Property(x => x.RoleId).IsRequired().HasMaxLength(128).IsUnicode(false);
