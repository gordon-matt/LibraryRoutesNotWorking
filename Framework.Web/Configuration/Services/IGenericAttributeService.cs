...
using Framework.Web.Configuration.Domain;
...
namespace Framework.Web.Configuration.Services
{
    ...
    {
        private const string GenericAttributeKeyFormat = "Framework.GenericAttribute.{0}-{1}";
        private const string GenericAttributePatternKey = "Framework.GenericAttribute.*";
