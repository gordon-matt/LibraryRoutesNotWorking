...
namespace Framework.Web.Configuration.Domain
{
    ...
    public class GenericAttributeMap : IEntityTypeConfiguration<GenericAttribute>, IFrameworkEntityTypeConfiguration
    {
        public void Configure(EntityTypeBuilder<GenericAttribute> builder)
        {
            builder.ToTable("Framework_GenericAttributes");
