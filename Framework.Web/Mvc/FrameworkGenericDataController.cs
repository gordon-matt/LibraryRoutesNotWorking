...
using Framework.Web.Mvc.KendoUI;
...
namespace Framework.Web.Mvc
{
    ...
    /// </summary>
    public abstract class FrameworkGenericDataController<TEntity, TKey> : FrameworkController
        where TEntity : class
    {
        ...
        public FrameworkGenericDataController(IGenericDataService<TEntity> service)
        {
            Service = service;
        ...
        public FrameworkGenericDataController(IRepository<TEntity> repository)
        {
