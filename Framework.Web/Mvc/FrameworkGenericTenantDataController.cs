...
{
    public abstract class FrameworkGenericTenantDataController<TEntity, TKey> : FrameworkGenericDataController<TEntity, TKey>
        where TEntity : class, ITenantEntity
    {
        ...
        public FrameworkGenericTenantDataController(IRepository<TEntity> repository)
            : base(repository)
        {
            workContext = EngineContext.Current.Resolve<IWorkContext>();
        }

        public FrameworkGenericTenantDataController(IGenericDataService<TEntity> service)
            : base(service)
        {
            workContext = EngineContext.Current.Resolve<IWorkContext>();
        }
