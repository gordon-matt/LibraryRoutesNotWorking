...
namespace Framework.Web.Areas.Admin.Localization.Controllers.Api
{
    public class LanguageApiController : GenericTenantODataController<LanguageEntity, Guid>
    {
        ...
        public virtual async Task<IActionResult> ResetLocalizableStrings([FromBody] ODataActionParameters parameters)
        {
            ...
            cacheManager.Value.RemoveByPattern(FrameworkConstants.CacheKeys.LocalizableStringsPatternFormat);
        ...
        {
            get { return FrameworkWebPermissions.LanguagesRead; }
        }

        protected override Permission WritePermission
        {
            get { return FrameworkWebPermissions.LanguagesWrite; }
        }
    }
}