...
namespace Framework.Web.Areas.Admin.Localization.Controllers.Api
{
    public class LocalizableStringApiController : GenericTenantODataController<LocalizableString, Guid>
    {
        ...
        public virtual async Task<IActionResult> PutComparitive([FromBody] ODataActionParameters parameters)
        {
            ...
            cacheManager.Remove(string.Concat(FrameworkConstants.CacheKeys.LocalizableStringsFormat, tenantId, cultureCode));
        ...
        {
            get { return FrameworkWebPermissions.LocalizableStringsRead; }
        }

        protected override Permission WritePermission
        {
            get { return FrameworkWebPermissions.LocalizableStringsWrite; }
        }
    }
}