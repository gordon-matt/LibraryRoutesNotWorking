...
namespace Framework.Logging.Domain
{
    ...
    public class LogEntryMap : IEntityTypeConfiguration<LogEntry>, IFrameworkEntityTypeConfiguration
    {
        public void Configure(EntityTypeBuilder<LogEntry> builder)
        {
            builder.ToTable("Framework_Log");
